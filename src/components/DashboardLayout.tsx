...
const LayoutInner = () => {
  ...
  const mainShiftClass = collapsed ? "lg:ml-[70px]" : "lg:ml-60";
  ...
  return (
    <div className="min-h-screen w-full bg-slate-50 dark:bg-[#020617] dark:text-slate-200 relative overflow-x-hidden transition-colors">
      ...
      {/* Main content shifted on desktop to match sidebar width */}
      <div
        className={cn(
          "min-h-screen flex flex-col ml-0 transition-[margin] duration-300 ease-in-out",
          mainShiftClass,
        )}
      >
        <TopNavbar />
