...
const LayoutInner = () => {
  const { collapsed, desktopCollapsedWidthPx, desktopExpandedWidthPx } = useSidebar();
  const ml = collapsed ? desktopCollapsedWidthPx : desktopExpandedWidthPx;

  return (
    <div
      className="min-h-screen w-full bg-slate-50 dark:bg-[#020617] dark:text-slate-200 relative overflow-x-hidden transition-colors"
      style={{ ["--sidebar-w" as never]: `${ml}px` }}
    >
      ...
      <div className="min-h-screen flex flex-col ml-0 lg:ml-[var(--sidebar-w)] transition-[margin] duration-300 ease-in-out">
        <TopNavbar />
