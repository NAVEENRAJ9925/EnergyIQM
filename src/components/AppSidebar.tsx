    ...
    >
      ...
      <div className="relative z-10 p-6 flex items-center gap-4 border-b border-sidebar-border dark:border-slate-800/80">
        ...
        {!isCollapsed && (
          ...
          >
            <h1 className="text-lg font-black text-sidebar-accent-foreground tracking-tight bg-gradient-to-r from-emerald-400 to-cyan-300 bg-clip-text text-transparent">EnergyIQ</h1>
